...
// Updated farm data to match the new API structure
const allFarms: Farm[] = [
  {
    farmId: "farm-1",
  ...
  },
  {
    ...
    produce: [
      ...
      },
      {
        ...
        name: "Limes",
        category: ["fruits"],
        description: "Fresh limes with zesty flavor and aromatic oils. Perfect for cocktails, cooking, and adding citrus notes to any dish.",
        pricePerUnit: 7.99,
        unit: "kg",
        minimumOrderQuantity: 1,
        minimumOrderUnit: "kg",
        availabilityWindows: [{ startMonth: 6, endMonth: 2 }],
